...
Subcommands:
    ...
    n4cluster server   --host 0.0.0.0 --port 8765 --state ./cluster-state [--token T] [--allow-python-jobs]
    n4cluster worker   --server URL [--token T] [--labels k=v,...] [--slots N] [--allow-python]
    n4cluster submit   job.yaml [--server URL] [--token T] [--wait] [--out DIR]
